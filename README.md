...
uv run webglass-cli whoami  # identity from culture.yaml
uv run webglass-cli learn   # self-teaching prompt (add --json)
...
1. Rename the package `webglass/` and the `webglass-cli`
